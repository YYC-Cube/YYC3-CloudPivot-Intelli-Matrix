...
const PALETTE_ITEMS: PaletteItem[] = [
  ...
  { id: "nav-models",     labelKey: "modelProvider.title", descKey: "modelProvider.subtitle", category: "nav",  icon: "Cpu",        path: "/model-provider" },
  ...
  { id: "nav-aidiag",     labelKey: "nav.aiDiagnostics", descKey: "aiDiag.subtitle",           category: "nav",  icon: "BrainCircuit", path: "/ai-diagnostics" },
