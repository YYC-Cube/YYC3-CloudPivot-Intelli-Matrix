...
"""
@file YYC³-CP-IM.py
@description YYC³-CP-IM 全文档架构一键生成脚本，用于生成符合YYC³（YanYuCloudCube）标准的完整文档架构，支持文档内容验证和自动更新功能
...
### YanYuCloudCube CloudPivot Intelli Matrix
...
PROJECT_STRUCT = {
    ...
    "02-YYC³-CP-IM-项目规划-架构设计": {
        "02-01-CP-IM-架构设计": [
            ...
            ("002", "分层式功能架构设计", "YYC³ 分层式功能架构设计，包含用户交互层、业务逻辑层、智能引擎层等", "[架构设计],[分层式架构],[功能分层]"),
        ...
        "02-02-CP-IM-详细设计": {
            ...
            "02-02-08-扩展演进层": [
                ...
                ("01-0", "生态建设-架构设计", "开发者社区、用户社区、知识库、最佳实践、成功案例的架构设计", "[详细设计],[扩展演进],[生态建设]"),
            ],
            "02-02-09-系统设置层": [
                ...
                ("01-0", "高级设置-架构设计", "系统维护、实验功能、开发者选项、系统信息、帮助与支持的架构设计", "[详细设计],[系统设置],[高级设置]"),
            ],
        },
        "02-03-CP-IM-数据设计": [
