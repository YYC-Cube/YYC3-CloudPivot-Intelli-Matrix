---
@file: YYC³-CP-IM-系统设置-目录映射.md
@description: YYC³-CP-IM 系统管理-系统设置
@author: YanYuCloudCube Team
@version: v2.0.0
@created: 2026-03-01
@updated: 2026-03-05
@status: published
@tags: [YYC³-CP-IM-操作手册],[系统管理],[系统设置],[目录映射]
---
...
本文档详细描述 YYC³ CP-IM(YanYuClouCube CloudPivot Intelli Matrix) 项目：系统管理 相关内容，确保项目按照 YYC³ 标准规范进行开发和实施。
