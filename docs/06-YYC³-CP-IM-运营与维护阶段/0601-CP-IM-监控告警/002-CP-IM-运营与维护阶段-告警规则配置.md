---
@file: 002-CP-IM-运营与维护阶段-告警规则配置.md
@description: YYC³-CP-IM 告警规则配置文档
...
# 06-YYC³-CP-IM-运营与维护阶段 - 0601-CP-IM-监控告警 - 告警规则配置
...
本文档详细描述 YYC³(YanYuClouCube)-CloudPivot Intelli-Matrix 06-YYC³-CP-IM-运营与维护阶段/0601-CP-IM-监控告警-告警规则配置 相关内容，确保项目按照 YYC³ 标准规范进行开发和实施。

### 文档目标

- 规范 告警规则配置 相关的业务标准与技术落地要求
- 为项目相关人员提供清晰的参考依据
