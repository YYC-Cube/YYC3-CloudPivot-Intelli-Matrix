---
@file: 001-CP-IM-项目设计阶段-UI_UX设计规范.md
@description: YYC³-CP-IM UI/UX 设计规范与标准
@author: YanYuCloudCube Team
@version: v2.0.0
@created: 2026-02-26
@updated: 2026-02-26
@status: published
@tags: [设计规范],[UI/UX],[设计标准]
---
...
# 02-YYC³-CP-IM-项目设计阶段 - 0207-CP-IM-设计规范 - UI_UX设计规范
...
本文档详细描述 YYC³(YanYuClouCube)-CloudPivot Intelli-Matrix 02-YYC³-CP-IM-项目设计阶段/0207-CP-IM-设计规范-UI_UX设计规范 相关内容，确保项目按照 YYC³ 标准规范进行开发和实施。

### 文档目标

- 规范 UI_UX设计规范 相关的业务标准与技术落地要求
- 为项目相关人员提供清晰的参考依据
