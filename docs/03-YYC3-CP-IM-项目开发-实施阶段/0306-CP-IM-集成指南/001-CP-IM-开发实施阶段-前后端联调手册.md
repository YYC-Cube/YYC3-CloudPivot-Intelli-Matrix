---
@file: 001-CP-IM-开发实施阶段-前后端联调手册.md
@description: YYC³-CP-IM 前后端联调手册
...
# 03-YYC³-CP-IM-开发实施阶段 - 0306-CP-IM-集成指南 - 前后端联调手册
...
本文档详细描述 YYC³(YanYuClouCube)-CloudPivot Intelli-Matrix 03-YYC³-CP-IM-开发实施阶段/0306-CP-IM-集成指南-前后端联调手册 相关内容，确保项目按照 YYC³ 标准规范进行开发和实施。

### 文档目标

- 规范 前后端联调手册 相关的业务标准与技术落地要求
- 为项目相关人员提供清晰的参考依据
